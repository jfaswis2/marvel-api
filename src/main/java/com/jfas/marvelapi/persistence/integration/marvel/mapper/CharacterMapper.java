...
public class CharacterMapper {
    ...
    public static List<CharacterDto> toDtoList(JsonNode rootNode) {
        ...
        resultsNode.elements().forEachRemaining( each -> characters.add(CharacterMapper.toDto(each)));
    ...
    public static List<CharacterDto.CharacterInfoDto> toInfoDtoList(JsonNode response) {
        ...
        resultsNode.elements().forEachRemaining( each -> characters.add(CharacterMapper.toInfoDto(each)));
